...
Examples:
  ...
  $0 ~/Проекты/MyProject1C --host mcp-host
  $0 ~/Проекты/MyProject1C --tools claude-code --host mcp-host
  $0 ~/Проекты/MyProject1C --host mcp-host --publish-url 'http://localhost/MyBase/ru/'
EOF
    exit 1
}
