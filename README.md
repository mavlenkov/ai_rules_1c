...
- **Koda CLI** (`.koda/rules/`, `.koda/agents/`, `.koda/commands/`, `.koda/skills/`; MCP через `/mcp add-http`; субагенты в JSON-формате `.koda/agents/<name>.json`; entry stub `KODA.md` → `AGENTS.md`)
