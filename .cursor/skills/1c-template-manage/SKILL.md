---
name: 1c-template-manage
description: "Add or remove templates/layouts from a 1C object (data processor, document, catalog, etc.). Use when managing SpreadsheetDocument (MXL), HTML, Text, or BinaryData templates."
---
...
```powershell
pwsh -NoProfile -File skills/1c-template-manage/scripts/add-template.ps1 -ProcessorName "<ObjectName>" -TemplateName "<TemplateName>" -TemplateType "<TemplateType>" [-Synonym "<Synonym>"] [-SrcDir "<SrcDir>"]
```
...
```powershell
pwsh -NoProfile -File skills/1c-template-manage/scripts/remove-template.ps1 -ProcessorName "<ObjectName>" -TemplateName "<TemplateName>" [-SrcDir "<SrcDir>"]
```
