# agent-execution-discipline Specification

## Purpose
Discipline rules for agent execution sessions: repeated work, failure visibility, explore/apply separation, and decision-focused user interaction. Created by archiving change refresh-fork-foundation.
